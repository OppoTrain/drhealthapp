      ...
      <div className="border-b border-gray-200 overflow-x-auto">
        <nav className="flex flex-wrap sm:flex-nowrap space-x-2 sm:space-x-8 min-w-max sm:min-w-0 px-8 justify-between">
          ...
          <button
            ...
            className={getTabClasses(activeTab === "measurements")}
          >
            <span className="flex items-center space-x-2">
              <img
                src="/Icons/accessibility_new.png"
          ...
          <button
            onClick={() => setActiveTab("MedicalInformation")}
            className={getTabClasses(activeTab === "MedicalInformation")}
          >
            <span className="flex items-center space-x-2">
              <img
                src="/Icons/medical_information.png"
                alt="Medical Icon"
                className="w-5 h-5"
              />
          ...
          <button
            onClick={() => setActiveTab("DietartyHabits")}
            className={getTabClasses(activeTab === "DietartyHabits")}
          >
            <span className="flex items-center space-x-2">
              <img
                src="/Icons/volunteer_activism.png"
                alt="Dietary Icon"
                className="w-5 h-5"
              />
          ...
          <button
            onClick={() => setActiveTab("SymptomsAndSigns")}
            className={getTabClasses(activeTab === "SymptomsAndSigns")}
          >
            <span className="flex items-center space-x-2">
              <img
          ...
          <button
            onClick={() => setActiveTab("MedicalReports")}
            className={getTabClasses(activeTab === "MedicalReports")}
          >
            <span className="flex items-center space-x-2">
              <img
          ...
          <button
            ...
            className={getTabClasses(activeTab === "Conclusion")}
          >
            <span className="flex items-center space-x-2">
              <img
